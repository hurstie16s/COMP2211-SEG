...
public class RunwayScene extends SceneAbstract {
  ...
  public void makeAlignButton(){
    ...
    RunwayLabel stripendRight = new RunwayLabel(Theme.getStripEnd(),rightDisplacementO.subtract(appWindow.runway.RESAWidthProperty()),-0.25,appWindow.runway.stripEndProperty().add(0),this,appWindow.runway.directionRightProperty().and(appWindow.runway.hasRunwayObstacleProperty()).and(appWindow.runway.rightLandProperty()));
    RunwayLabel stripendRightSlope = new RunwayLabel(Theme.getStripEnd(),rightDisplacementO.subtract(slopeLength),-0.25,appWindow.runway.stripEndProperty().add(0),this,appWindow.runway.directionRightProperty().and(appWindow.runway.hasRunwayObstacleProperty()).and(appWindow.runway.rightLandProperty()).and(Bindings.greaterThan(slopeLength,appWindow.runway.RESAWidthProperty())));
    ...
    group.getChildren().addAll(resaLeft, stripendLeft, blastAllowanceLeft, resaRight, stripendRight, blastAllowanceRight, stripendLeftSlope, stripendRightSlope, resaLeft2, stripendLeft2, blastAllowanceLeft2, resaRight2, stripendRight2, blastAllowanceRight2, stripendLeft2Slope, stripendRight2Slope);
